...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = neuronInitAndCompute3HardCoded
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = neuron3
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = neuronInitAndCompute3
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = neuronInitAndCompute3
END
