...
#ifndef __neuronInitAndCompbkb__HH__
#define __neuronInitAndCompbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(neuronInitAndCompbkb) {
    ...
    SC_CTOR(neuronInitAndCompbkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
