...
set ID 11
set MemName digitRecognizer_hg8j_memcore
...
set MemName digitRecognizer_hg8j
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 12 \
			corename digitRecognizer_digrec_io_axilite \
			name digitRecognizer_digrec_io_s_axi \
			ports {$port_digrec_io} \
			op interface \
		} "
	} else {
		puts "@W \[IMPL-110\] Cannot find AXI Lite interface model in the library. Ignored generation of AXI Lite  interface for 'digrec_io'"
	}
}

if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler digitRecognizer_digrec_io_s_axi
}
