...
#ifndef __digitRecognizer_feOg__HH__
#define __digitRecognizer_feOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(digitRecognizer_feOg) {
    ...
    SC_CTOR(digitRecognizer_feOg):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
