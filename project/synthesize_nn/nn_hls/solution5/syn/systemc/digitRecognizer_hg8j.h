...
#ifndef _digitRecognizer_hg8j_H_
#define _digitRecognizer_hg8j_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "digitRecognizer_hg8j_memcore.h"

SC_MODULE(digitRecognizer_hg8j) {
...
protected:
    ...
    digitRecognizer_hg8j_memcore* digitRecognizer_hg8j_memcore_U;
...
public:
    ...
    SC_CTOR(digitRecognizer_hg8j) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        digitRecognizer_hg8j_memcore_U = new digitRecognizer_hg8j_memcore("digitRecognizer_hg8j_memcore_U");
        digitRecognizer_hg8j_memcore_U->clk      ( clk );
        digitRecognizer_hg8j_memcore_U->reset    ( reset );
        digitRecognizer_hg8j_memcore_U->ce0      ( i_ce0 );
        digitRecognizer_hg8j_memcore_U->we0      ( i_we0 );
        digitRecognizer_hg8j_memcore_U->address0 ( memcore_iaddr );
        digitRecognizer_hg8j_memcore_U->d0       ( i_d0 );
        digitRecognizer_hg8j_memcore_U->q0       ( i_q0 );

        digitRecognizer_hg8j_memcore_U->ce1      ( t_ce0 );
        digitRecognizer_hg8j_memcore_U->we1      ( t_we0 );
        digitRecognizer_hg8j_memcore_U->address1 ( memcore_taddr );
        digitRecognizer_hg8j_memcore_U->d1       ( t_d0 );
        digitRecognizer_hg8j_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "digitRecognizer_hg8j.trace");
            // ports
