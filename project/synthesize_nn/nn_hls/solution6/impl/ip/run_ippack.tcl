...
set Library     "hls"
set IPName      "digitRecognizer"
set Version     "1.0"
set DisplayName "digRec_v6"
set Revision    "1812181221"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "digitRecognizer"
...
set Interfaces {
    s_axi_digrec_io {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_digrec_io"
        param_prefix "C_S_AXI_DIGREC_IO"
        addr_bits "14"
        ...
        memories "inputData {base_address 4096 range 4096} output_r {base_address 8192 range 64}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 8.000000 machine 64 combinational 0 latency 176474 II x}
...
set enable_xo_gen 0
set kernel_files {C:/Users/Lukas/Desktop/embedded-rts/project/synthesize_nn/nn_hls/src/digitRecognizer.cpp}
if {$enable_xo_gen} {
