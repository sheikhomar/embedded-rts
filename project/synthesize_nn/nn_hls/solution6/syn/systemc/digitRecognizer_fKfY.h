...
#ifndef __digitRecognizer_fKfY__HH__
#define __digitRecognizer_fKfY__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(digitRecognizer_fKfY) {
    ...
    SC_CTOR(digitRecognizer_fKfY):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
