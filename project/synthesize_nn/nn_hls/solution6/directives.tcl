...
set_directive_array_partition -type complete -factor 32 -dim 1 "digitRecognizer" inputToHiddenWeights
set_directive_array_partition -type complete -factor 10 -dim 1 "digitRecognizer" hiddenToOutputWeights
...
set_directive_dataflow "digitRecognizer/ih_loop"
