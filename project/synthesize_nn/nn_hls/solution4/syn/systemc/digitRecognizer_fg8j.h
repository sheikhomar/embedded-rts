...
#ifndef __digitRecognizer_fg8j__HH__
#define __digitRecognizer_fg8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(digitRecognizer_fg8j) {
    ...
    SC_CTOR(digitRecognizer_fg8j):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
